...
| ZGGG_E_TWR | 白云塔台 Baiyun Tower | 123.550  | 03/21 跑道 |
...
|   登录名   |          呼号          |  频率   |     职责范围     |
| :--------: | :--------------------: | :-----: | :--------------: |
|  ZGGG_GND  | 白云地面 Baiyun Ground | 121.750 |      西一、东一、东二、东三地面管制区 (不含包含绕滑及 Y 滑行道)      |
| ZGGG_E_GND | 白云地面 Baiyun Ground | 121.550 | 东二、东三地面管制区 (不含包含绕滑) |
