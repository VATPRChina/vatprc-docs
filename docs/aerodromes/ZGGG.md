...
1. DCL 登录名 ZGGG
2. 多个放行席位在线时，原则上 DCL 由 ZGGG_DEL 操作
3. 多个地面席位在线且无放行席位在线时，原则上 DCL 由 ZGGG_GND 操作
4. 多个塔台席位在线且无地面、放行席位在线时，原则上 DCL 由 ZGGG_TWR 操作
5. 操作 DCL 的席位需要参照各席位管制范围在 PDC 的 NEXT FREQ 中注明航空器需要联系的席位的频率
