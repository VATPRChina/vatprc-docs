...
由北京首都机场出发沿京广大通道南下的航空器，不得由ELKUR方向离场后沿W40航路南下后沿W562/W4航路向西加入W37/A461航路，应由RUSDO方向离场
...
|RUSDO|36L|RUSDO-9ZD|
|RUSDO|36R|RUSDO-9YD|
有管制席位对北京终端区提供管制服务时，使用跑道36R离场的航空器离地后需保持跑道航迹(maintain runway track)，与相关管制员协调时相关管制员明确表示不需要的除外，并注意英文表达(使用Extend runway centerline容易造成歧义)
...
经区域管制席位提出，进近管制席位同意方可启用LULTA方向离场，使用程序现场协调

F类航空器不可使用18R/36L跑道，运行跑道为18L/36R跑道、01/19跑道

任何航空器禁止以任何形式飞越ZB(P)801和禁止绕飞区
