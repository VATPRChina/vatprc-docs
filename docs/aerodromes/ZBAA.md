...
为了确保 VATPRC 管辖范围内的北京首都机场（ZBAA）实现安全、合规和高效的运营，依据中国民用航空局（CAAC）发布的《中华人民共和国航空资料汇编》（AIP CHINA），结合 VATPRC 的实际运行情况，制定了适用于北京首都机场（ZBAA）的标准运行程序。
