...
![alt text](<【已改 V250712】机坪管制范围.png>)
...
1. 滑行道使用
   ![alt text](<【已改 V250705】北向滑行路线.png>)
...
1. 滑行道使用
   ![alt text](<【已改 V250712】南向滑行路线.png>)
...
|   18L    |             5 号机坪北侧              |            T5->G            |
|   18L    |             5 号机坪西侧              |              H              |
|   18L    |             5 号机坪东侧              | K->T5->G 或 T4->Y4->G 或 T4->H |
|   18L    |               4 号机坪                |       T2->H 或 T4->H        |
|   18L    |               3 号机坪                |           T2->H            |
|    19    |             5 号机坪北侧              |            T6->K            |
|    19    |             5 号机坪西侧              |      G->T6->K 或 T3->J      |
|    19    |     931-935 机位、北绕滑 Y7 向南      |          H->T6->K           |
|    19    |             5 号机坪东侧              |              K              |
|    19    |               4 号机坪                |        T1->J 或 T3->J      |
|    19    |               3 号机坪                |            T1->J           |
