...
1. 多个放行席位在线时，原则上 DCL 一律由 ZBAA_DEL 操作
2. 多个塔台席位在线且无地面、放行席位在线时，原则上 DCL 一律由 ZBAA_TWR 操作
3. 操作 DCL 的席位需要参照各放行席位管制范围在 PDC 的 NEXT FREQ 中注明航空器需要联系的放行席位的频率
