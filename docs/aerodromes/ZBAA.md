...
| :--------: | :------: | :-------------------------------------: | :-------------------------------------------------------------------------: | :--------: |
|  ZBAA_RMP  |   北向   |           沿 G0、G1、G2 滑出            |                                    G 前                                     |  ZBAA_TWR  |
|  ZBAA_RMP  |   北向   |             沿 K1、K2 滑出              |                                    K 前                                     |  ZBAA_TWR  |
|  ZBAA_RMP  |   北向   |                    /                    |                              T1 J 前、T2 H 前                               |  ZBAA_GND  |
|  ZBAA_RMP  |   南向   |            沿 T2 A1 穿越跑道            |                                   在 H 前                                   |  ZBAA_TWR  |
|  ZBAA_RMP  |   南向   |                    /                    | T1 J 前、T2 H 前、T4/Y1/Y8 H 前、T3/Y4/Y8 J 前、Y3 J1 前、Y6 J4 前、J U2 前 |  ZBAA_GND  |
| ZBAA_W_RMP |   北向   | 在M7 到 F0 之间滑行的、不在 Z3 上滑行的 |                                     F前                                     |  ZBAA_TWR  |
| ZBAA_W_RMP |   北向   |      在 Z3 上滑行，预计转向上 F 的      |                         航空器到达预计转向的道口前                          |  ZBAA_TWR  |
| ZBAA_W_RMP |   北向   |                F向南滑行                |                                    M7前                                     |  ZBAA_TWR  |
| ZBAA_W_RMP |   北向   |                    /                    |                                     A9                                      |  ZBAA_TWR  |
| ZBAA_W_RMP |   北向   |                    /                    |                                     C前                                     | ZBAA_W_TWR |
| ZBAA_W_RMP |   北向   |                    /                    |                                  Z2 HP7前                                   | ZBAA_W_TWR |
| ZBAA_W_RMP |   北向   |   W211-W213 机位的航空器准备好滑行后    |                                  原地移交                                   | ZBAA_W_TWR |
| ZBAA_W_RMP |   北向   |                    /                    |                              Route2（Y7）H2 前                              |  ZBAA_GND  |
| ZBAA_W_RMP |   南向   |                    /                    |                                   F W7前                                    |  ZBAA_TWR  |
| ZBAA_W_RMP |   南向   |          沿 Z3 F2 A0 穿越跑道           |                                    F2前                                     |  ZBAA_TWR  |
| ZBAA_W_RMP |   南向   |   沿 Route3、Route1 去往 18L 跑道离场   |                                HP4（S4 前）                                 |  ZBAA_TWR  |
| ZBAA_W_RMP |   南向   |                    /                    |                                     C前                                     | ZBAA_W_TWR |
| ZBAA_W_RMP |   南向   |                    /                    |                              Route2（Y7）H2 前                              |  ZBAA_GND  |
...
| MUGLO  |        日朝韩（除RKSI、RKSS外）、北美        | 8900 以上米制单数 |                              主用离场点                               |
