...
1. DCL 登录名 ZBAA
2. 多个放行席位在线时，原则上 DCL 由 ZBAA_DEL 操作
3. 多个塔台席位在线且无地面、放行席位在线时，原则上 DCL 由 ZBAA_TWR 操作
4. 操作 DCL 的席位需要参照各席位管制范围在 PDC 的 NEXT FREQ 中注明航空器需要联系的席位的频率
