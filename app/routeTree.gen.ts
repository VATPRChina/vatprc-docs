...
const PilotIntroductionToFlyIndexRoute = PilotIntroductionToFlyIndexImport.update({
...
const ControllerVisitingAndTransferringIndexRoute = ControllerVisitingAndTransferringIndexImport.update({
...
const ControllerControllerRegulationsIndexRoute = ControllerControllerRegulationsIndexImport.update({
  id: "/controller/controller-regulations/",
  path: "/controller/controller-regulations/",
  getParentRoute: () => rootRoute,
} as any);

const ControllerControllerListIndexRoute = ControllerControllerListIndexImport.update({
  id: "/controller/controller-list/",
  path: "/controller/controller-list/",
  getParentRoute: () => rootRoute,
} as any);

const ControllerBecomeAControllerIndexRoute = ControllerBecomeAControllerIndexImport.update({
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ControllerControllerRegulationsIndexRoute: ControllerControllerRegulationsIndexRoute,
  ControllerLoaIndexRoute: ControllerLoaIndexRoute,
  ControllerSectorIndexRoute: ControllerSectorIndexRoute,
  ControllerVisitingAndTransferringIndexRoute: ControllerVisitingAndTransferringIndexRoute,
