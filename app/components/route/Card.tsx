...
const MantineLinkComponent = React.forwardRef<HTMLAnchorElement, MantineCardProps>((props, ref) => {
...
export const RouteCard: LinkComponent<typeof MantineLinkComponent> = (props) => {
